...
title: AI Brief
date: 2026-06-01 08:00:00 +0800 # 發表日期和時間 (請根據您當前的時區調整 +0800 代表 UTC+8)
...
#### CNN - Convolutional Neural Network（卷積層神經網路）
...
<iframe width="850" height="478" src="https://www.youtube.com/embed/QLiKmca4kzI" title="【生成式AI時代下的機器學習(2025)】第一講：一堂課搞懂生成式人工智慧的技術突破與未來發展" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
---
### Text-to-Image
* xAI [Grok Imagine](https://grokimagine.ai/)
...
### Text-to-Video
#### Grok Imagine 1.5 
<iframe width="850" height="478" src="https://www.youtube.com/embed/grxiFAC-NNI" title="Grok Imagine 1.5 Preview - Mind-Blowing AI Video Just Dropped 🔥 | xAI" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<iframe width="845" height="475" src="https://www.youtube.com/embed/IrA0mzZTwLo" title="Gemini Omni is Totally Wild (Google’s New Video Model)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

#### LTX 2.3
<iframe width="845" height="475" src="https://www.youtube.com/embed/53ULREnV1uk" title="LTX 2.3 微调模型集合：更好的一致性保持和动作表现、更精确的提示词操控，还能去字幕和水印" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

---
## AGI - Artificial General Intelligence (通用人工智慧)

### Agentic Engineering （代理工程）
**Blog**: [從 Vibe Coding 到 Agentic Engineering：Karpathy 宣告軟體開發的世代交替](https://jasonchuang.substack.com/p/agentic-engineering-karpathy) <br>

### Harness Engineering（駕馭工程）
**Blog**: [Harness Engineering 完全解析：當 AI Agent 的護城河不再是模型，而是環境](https://hackmd.io/@BASHCAT/SkQEW0F2bg) <br>

### Loop Engineering (迴圈工程)
**Blog**: [Google 工程師教你什麼是 Loop Engineering？五個積木＋外部記憶，2026 的 AI 必修課](https://www.blocktempo.com/loop-engineering-addy-osmani/) <br>
![](https://media.licdn.com/dms/image/v2/D5622AQEcUsq3DTXnog/feedshare-shrink_800/B56Z8ZRiC.LAAc-/0/1782835454404?e=1785974400&v=beta&t=0TvqCjuuww21HBTFxAMdB009hdg8m_W5_h_Df0BLTRc)

**Blog**: [迴圈工程](https://www.bnext.com.tw/article/91246/loop-engineering-from-prompting-to-designing-ai-coding-loops)
...
**Github**: [https://github.com/cobusgreyling/loop-engineering](https://github.com/cobusgreyling/loop-engineering) <br>
![](https://github.com/cobusgreyling/loop-engineering/raw/main/assets/visuals/LE5.jpeg)
...
---
### Companion Humanoid
<iframe width="1022" height="575" src="https://www.youtube.com/embed/0nT6b9E-SGQ" title="仿真男女友來了! 陸廠伴侶機器人預購秒殺｜TVBS新聞" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
