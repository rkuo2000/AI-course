...
tags: [CNN] # 文章標籤，您可以自訂
description: Convolutional Neural Networks (卷積層神經網路)
...
![](https://github.com/rkuo2000/AI-course/blob/main/assets/images/Sign_Language_MNIST.png?raw=true)
...
**Kaggle:** [FashionMNIST-CNN](https://www.kaggle.com/rkuo2000/fashionmnist-cnn), [FashionMNIST-PyTorch](https://www.kaggle.com/rkuo2000/fashionmnist-pytorch)<br>

---
### AirDigit (空中手寫數字)
**Dataset:**<br>
![](https://github.com/rkuo2000/AI-course/blob/main/assets/images/AirDigit_dataset.png?raw=true)
...
![](https://github.com/rkuo2000/AI-course/blob/main/assets/images/ECG_CNN.png?raw=true)
...
![](https://github.com/rkuo2000/AI-course/blob/main/assets/images/PPG2AGP_pipeline.png?raw=true)
![](https://github.com/rkuo2000/AI-course/blob/main/assets/images/PPG2AGP_pipeline_output.png?raw=true)
...
![](https://github.com/rkuo2000/AI-course/blob/main/assets/images/Sound_Digit_waveform.png?raw=true)
<br>
...
![](https://github.com/rkuo2000/AI-course/blob/main/assets/images/Sound_Digit_mel_freq_spectrogram.png?raw=true)
...
![](https://github.com/rkuo2000/AI-course/blob/main/assets/images/urban_sound_cnn.png?raw=true)
...
---
### EfficientNet V2
**Paper**: [EfficientNetV2: Smaller Models and Faster Training](https://arxiv.org/abs/2104.00298)<br>
**Code**: [https://github.com/abhuse/pytorch-efficientnet](https://github.com/abhuse/pytorch-efficientnet)<br>
