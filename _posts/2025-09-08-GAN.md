...
title: VAE/GAN
date: 2025-09-08 08:00:00 +0800 # 發表日期和時間 (請根據您當前的時區調整 +0800 代表 UTC+8)
categories: [Lecture] # 文章分類，您可以自訂
tags: [GAN] # 文章標籤，您可以自訂
description: Style Transfer, Variational AutoEncoder, Generative Adversarial Network (生成對抗網路）
