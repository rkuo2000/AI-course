...
**Arxiv**: [LLaMA: Open and Efficient Foundation Language Models](https://arxiv.org/abs/2302.13971)<br>
...
---
### GPT4
**Arxiv**: [GPT-4 Technical Report](https://arxiv.org/abs/2303.08774)<br>
![](https://image-cdn.learnin.tw/bnextmedia/image/album/2023-03/img-1679884936-23656.png?w=1200&output=webp)
**Arxiv**: [From Sparse to Dense: GPT-4 Summarization with Chain of Density Prompting](https://arxiv.org/abs/2309.04269)<br>
...
**Arxiv**: [The RefinedWeb Dataset for Falcon LLM: Outperforming Curated Corpora with Web Data, and Web Data Only](https://arxiv.org/abs/2306.01116)<br>

---
### Vicuna
**HuggingFace**: [lmsys/vicuna-7b-v1.5](https://huggingface.co/lmsys/vicuna-7b-v1.5)<br>
**Arxiv**: [Judging LLM-as-a-Judge with MT-Bench and Chatbot Arena](https://arxiv.org/abs/2306.05685)<br>
**Github**: [https://github.com/lm-sys/FastChat](https://github.com/lm-sys/FastChat)<br>
...
**Github**: [https://github.com/facebookresearch/llama](https://github.com/facebookresearch/llama)<br>

---
### Mistral
**HuggingFace**: [mistralai/Mistral-7B-Instruct-v0.2](https://huggingface.co/mistralai/Mistral-7B-Instruct-v0.2)<br>
**Arxiv**: [Mistral 7B](https://arxiv.org/abs/2310.06825)<br>
**Github**: [https://github.com/mistralai/mistral-src](https://github.com/mistralai/mistral-src)<br>
...
**Arxiv**: [Mixtral of Experts](https://arxiv.org/abs/2401.04088)<br>
...
**Arxiv**: [https://arxiv.org/abs/2311.11045](https://arxiv.org/abs/2311.11045)<br>
...
**Arxiv**: [TAIWAN-LLM: Bridging the Linguistic Divide with a Culturally Aligned Language Model](https://arxiv.org/abs/2311.17487)<br>
**Blog**: [專屬台灣！優必達攜手台大打造「Taiwan LLM」，為何我們需要本土化的AI？](https://www.bnext.com.tw/article/77335/ubitus-ai-taiwan-llm)<br>
**Github**: [https://github.com/MiuLab/Taiwan-LLM](https://github.com/MiuLab/Taiwan-LLM)<br>
...
**Arxiv**: [Mamba: Linear-Time Sequence Modeling with Selective State Spaces](https://arxiv.org/abs/2312.00752)<br>
...
**Github**: [https://github.com/QwenLM/Qwen1.5](https://github.com/QwenLM/Qwen1.5)<br>

---
### Yi (零一万物)
**HuggingFace**: [01-ai/Yi-6B-Chat](https://huggingface.co/01-ai/Yi-6B-Chat)<br>
**Arxiv**: [CMMMU: A Chinese Massive Multi-discipline Multimodal Understanding Benchmark](https://arxiv.org/abs/2401.11944)<br>
**Arxiv**: [Yi: Open Foundation Models by 01.AI](https://arxiv.org/abs/2403.04652)<br>

---
### Orca-Math
**Arxiv**: [Orca-Math: Unlocking the potential of SLMs in Grade School Math](https://arxiv.org/abs/2402.14830)<br>
...
**Arxiv**: [BitNet: Scaling 1-bit Transformers for Large Language Models](https://arxiv.org/abs/2310.11453)<br>
**Arxiv**: [The Era of 1-bit LLMs: All Large Language Models are in 1.58 Bits](https://arxiv.org/abs/2402.17764)<br>
...
**Arxiv**: [Breeze-7B Technical Report](https://arxiv.org/abs/2403.02712)<br>
...
**Arxiv**: [Bailong: Bilingual Transfer Learning based on QLoRA and Zip-tie Embedding](https://arxiv.org/abs/2404.00862)<br>
...
**Github**: [https://github.com/meta-llama/llama3/](https://github.com/meta-llama/llama3/)<br>
...
**Arxiv:** [Octopus v4: Graph of language models](https://arxiv.org/abs/2404.19296)<br>
**Github:** [https://github.com/NexaAI/octopus-v4](https://github.com/NexaAI/octopus-v4)<br>
...
**Arxiv**: [NVLM: Open Frontier-Class Multimodal LLMs](https://arxiv.org/abs/2409.11402)<br>
...
---
### DeepSeek-R1
**Arxiv**: [DeepSeek-R1: Incentivizing Reasoning Capability in LLMs via Reinforcement Learning](https://arxiv.org/abs/2501.12948)<br>
**Github**: [https://github.com/deepseek-ai/DeepSeek-R1](https://github.com/deepseek-ai/DeepSeek-R1)<br>
...
**Github**: [Github](https://github.com/ollama/ollama)<br>
...
**Github**: [https://github.com/menloresearch/jan](https://github.com/menloresearch/jan)<br>

---
### [PrivateGPT](https://github.com/zylon-ai/private-gpt)
**Github**: [https://github.com/zylon-ai/private-gpt/tree/primordial](https://github.com/zylon-ai/private-gpt/tree/primordial)<br>
...
---
## RLM
**Arxiv**: [Reasoning Language Models: A Blueprint](https://arxiv.org/pdf/2501.11223)<br>
...
**Arxiv**: [Chain-of-Thought Prompting Elicits Reasoning in Large Language Models](https://arxiv.org/abs/2201.11903)<br>
![](https://ar5iv.labs.arxiv.org/html/2201.11903/assets/x1.png)

---
### [ReAct Prompting](https://react-lm.github.io/)
**Arxiv**: [ReAct: Synergizing Reasoning and Acting in Language Models](https://arxiv.org/abs/2210.03629)<br>
**Github**: [https://github.com/ysymyth/ReAct](https://github.com/ysymyth/ReAct)<br>
![](https://react-lm.github.io/files/diagram.png)

---
### Tree-of-Thoughts
**Arxiv**: [Tree of Thoughts: Deliberate Problem Solving with Large Language Models](https://arxiv.org/abs/2305.10601)<br>
**Github**: [https://github.com/princeton-nlp/tree-of-thought-llm](https://github.com/princeton-nlp/tree-of-thought-llm)<br>
**Github**: [https://github.com/kyegomez/tree-of-thoughts](https://github.com/kyegomez/tree-of-thoughts)<br>
![](https://github.com/princeton-nlp/tree-of-thought-llm/blob/master/pics/teaser.png?raw=true)

---
### Tabular CoT
**Arxiv**: [Tab-CoT: Zero-shot Tabular Chain of Thought](https://arxiv.org/abs/2305.17812)<br>
**Github**: [https://github.com/Xalp/Tab-CoT](https://github.com/Xalp/Tab-CoT)<br>
...
![](https://github.com/rkuo2000/AI-course/blob/main/images/LLM_Context_vs_Prompt.png?raw=true)
