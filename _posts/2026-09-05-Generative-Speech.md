...
date: 2026-09-05 09:00:00 +0800 # 發表日期和時間 (請根據您當前的時區調整 +0800 代表 UTC+8)
categories: [Lecture] # 文章分類，您可以自訂
tags: [AIGC] # 文章標籤，您可以自訂
description: Text-To-Speech, Voice Cloning, Speech-To-Text
...
---
### OmniVoice
#### Paper: [OmniVoice: Towards Omnilingual Zero-Shot Text-to-Speech with Diffusion Language Models](https://arxiv.org/html/2604.00688)
...
#### [hexgard/Kokoro-82M](https://huggingface.co/hexgrad/Kokoro-82M)

`pip install kokoro`<br>
