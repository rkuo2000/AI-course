...
#### Blog: [阿里雲AI算力大升級！發佈100個開源Qwen 2.5模型及視頻AI模型](https://itpromag.com/2024/09/20/alicloud-qwen/)
...
---
### Llama-Breeze2
#### HuggingFace: [MediaTek-Research/Llama-Breeze2-8B-Instruct](https://huggingface.co/MediaTek-Research/Llama-Breeze2-8B-Instruct)
...
![](https://api-docs.deepseek.com/img/v3.2_251201_benchmark.webp)
![](https://api-docs.deepseek.com/img/v3.2_251201_benchmark_table_en.png)
...
We’re also releasing GPT‑5.4 Pro in ChatGPT and the API, for people who want maximum performance on complex tasks.<br>
...
---
### mHC 
**Paper**: [mHC: Manifold-Constrained Hyper-Connections](https://arxiv.org/html/2512.24880v2)<br>
![](https://arxiv.org/html/2512.24880v2/x1.png)

---
### Attention Residuals
**Paper**: [Attention Residuals](https://arxiv.org/abs/2603.15031)<br>
**Code**: [https://github.com/MoonshotAI/Attention-Residuals](https://github.com/MoonshotAI/Attention-Residuals)<br>
![](https://github.com/MoonshotAI/Attention-Residuals/raw/master/assets/overview.png)

---
### EverMemOS
**Paper**: [EverMemOS : A Self-Organizing Memory Operating System for Structured Long-Horizon Reasoning](https://arxiv.org/abs/2601.02163)<br>

---
### Continually Self-Improving AI
**Paper**: [Continually self-improving AI](https://arxiv.org/abs/2603.18073)<br>
