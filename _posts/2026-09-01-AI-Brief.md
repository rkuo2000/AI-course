...
title: AI Brief
date: 2026-09-01 09:00:00 +0800 # 發表日期和時間 (請根據您當前的時區調整 +0800 代表 UTC+8)
categories: [Lecture] # 文章分類，您可以自訂
tags: [basic] # 文章標籤，您可以自訂
description: AI簡介：演進, 應用, 新聞, 影響及趨勢, 未來
...
#### Milestones :
* 1997 - LSTM/RNN [遞歸神經網路] - [Long Short-Term Memory](https://www.bioinf.jku.at/publications/older/2604.pdf)
* 1998 - LeNet/CNN [卷積神經網路] - [Gradient-Based Learning Applied to Document Recognition](http://vision.stanford.edu/cs598_spring07/papers/Lecun98.pdf)
* 2013 - Deep-Q Learning [強化學習] - [Playing Atari with Deep Reinforcement Learning](https://arxiv.org/html/1312.5602v1)
* 2014 - GAN [生成式對抗網路] - [Generative Adversarial Networks](https://arxiv.org/html/1406.2661v1)
* 2016 - AlphaGo [阿爾法圍棋] - [Mastering the game of Go with deep neural networks and tree search](https://research.google/pubs/mastering-the-game-of-go-with-deep-neural-networks-and-tree-search/)
* 2016 - NMT [神經機器翻譯] - [Google's Neural Machine Translation System: Bridging the Gap between Human and Machine Translation](https://arxiv.org/html/1609.08144v2)
* 2016 - WaveNet [語音合成] - [WaveNet: A Generative Model for Raw Audio](https://arxiv.org/html/1609.03499v2)
...
#### RNN - Recurrent Neural Network（遞歸神經網路）
...
* 2024/05/08 - [AlphaFold 3](https://github.com/google-deepmind/alphafold3)
* 2025/02/24 - [Introducing Claude Code](https://www.youtube.com/watch?v=AJpK3YTTKZ4)
* 2025/11/27 - [Z-Image-Turbo](ttps://huggingface.co/Tongyi-MAI/Z-Image-Turbo)
* 2026/01/06 - [Lightricks LTX-2.3](https://huggingface.co/Lightricks/LTX-2.3)
* 2026/01/30 - [OpenClaw (龍蝦)](https://github.com/openclaw/openclaw)
* 2026/07/31 - [MiniMax H3: An Open Model Breaking the Boundaries Between Tasks and Modalities](https://www.minimax.io/blog/minimax-h3)
* 2026/09/03 - [GPT-6 Astra: A new generation of intelligence](https://openai.com/index/gpt-6-astra/)
  
### Large Language Model (大型語言模型)
* OpenAI : GPT-6 Astra
* Anthropic : Claude Fable-5.1, Mythos 5.1, Opus 5
* xAI : Grok-4.6
...
#### [GPT-6 Astra Showcase](https://developers.openai.com/showcase)
<iframe width="1289" height="725" src="https://www.youtube.com/embed/k3jUYvEGdf4" title="GPT-6 Astra的50个惊艳玩法！做游戏、造3D世界，还能办公剪视频，AI开始操作软件了！" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

<iframe width="1289" height="725" src="https://www.youtube.com/embed/u21HF3q9-nM" title="GPT-6 Astra到底有多強？用Codex連做3個互動功能，完整實測！" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

---
#### Generative Video
[ComfyUI](https://github.com/comfy-org/comfyui)
<iframe width="1289" height="724" src="https://www.youtube.com/embed/9lzql8F12T8" title="文戏不油腻，武戏超丝滑！12G显存也能跑15秒！MiniMax H3保姆级整合包【包含提示词模版】" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

<iframe width="1289" height="725" src="https://www.youtube.com/embed/86ALhc0udWI" title="我用 AI + Unreal 做出了 GTA 台灣版？ (含完整實作教學)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

---
#### Personal Agent/Bot

**[Hermes-Agent](https://github.com/nousresearch/hermes-agent)** <br>
`curl -fsSL https://hermes-agent.nousresearch.com/install.sh | bash` <br>

`hermes desktop`<br>

**[NemoClaw](https://github.com/NVIDIA/NemoClaw)** <br>
`curl -fsSL https://www.nvidia.com/nemoclaw.sh | NEMOCLAW_AGENT=hermes NEMOCLAW_SANDBOX_NAME=my-hermes bash`<br>

[autonomous mushroom cultivation](https://github.com/setasoma/mycodo-hermes-skill)<br>
<iframe width="1289" height="725" src="https://www.youtube.com/embed/8L_yLB3wbFE" title="在黑客松中得獎的Hermes Agent玩法顛覆想像！拿來種香菇、開公司、寫出50萬字歷史？｜Kelly Tsai" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

---
## AI News

### 2026
* [2026/09/10 Introducing DeepSeek-V4.1-Flash: smarter, faster, more efficient](https://www.deepseek.com/en/news/deepseek-v4-1-flash/)
* [2026/09/03 GPT-6 Astra: A new generation of intelligence](https://openai.com/index/gpt-6-astra/)
* [2026/09/01 Atlas: A World Model for Spatial Intelligence](https://www.worldlabs.ai/blog/atlas)
* [2026/08/30 OpenClaw 2.0, Accidentally](https://openclaw.ai/blog/openclaw-2-accidentally)
* [2026/08/14 GLM-5.3: Frontier Coding with Emergent Cyber Capabilities](https://z.ai/blog/glm-5.3)
* [2026/08/13 MiniMax Music 3.0: Next-Generation Open-Weights, Production-Ready & Versatile Music Model](https://www.minimax.io/blog/minimax-music-3-0-next-generation-open-weights-production-ready-versatile-music-model)
* [2026/08/07 Imagine Image 2.0](https://x.ai/news/grok-imagine-image-2)
* [2026/07/31 MiniMax H3: An Open Model Breaking the Boundaries Between Tasks and Modalities](https://www.minimax.io/blog/minimax-h3)
* [2026/07/31 Frontis-MA1: Training an AI4AI Model towards Recursive Self-Improvement in Machine Learning Engineering](https://frontisai.github.io/OpenRSI/)
* [2026/07/19 Qwen3.8-MAX preview](https://www.yottalabs.ai/post/qwen-3-8-max-release-date-specs-how-to-access-2026)
* [2026/07/14 Kimi K3: Open Frontier Intelligence](https://www.kimi.com/blog/kimi-k3)
* [2026/07/09 GPT-5.6: Frontier intelligence that scales with your ambition](https://openai.com/zh-Hant/index/gpt-5-6/)
* [2026/06/16 GLM-5.2: Built for Long-Horizon Tasks](https://z.ai/blog/glm-5.2)
* [2026/06/10 DiffusionGemma: 4x faster text generation](https://blog.google/innovation-and-ai/technology/developers-tools/diffusion-gemma-faster-text-generation/)
* [2026/06/09 Introducing Claude Fable 5 and Claude Mythos 5](https://platform.claude.com/docs/en/about-claude/models/introducing-claude-fable-5-and-claude-mythos-5)
* [2026/06/03 Grok Imagine 1.5 Preview](https://x.ai/news/grok-imagine-1-5)
* [2026/06/03 Introducing Gemma 4 12B: a unified, encoder-free multimodal model](https://blog.google/innovation-and-ai/technology/developers-tools/introducing-gemma-4-12b/)
* [2026/05/28 Introducing Claude Opus 4.8](https://www.anthropic.com/news/claude-opus-4-8)
* [2026/05/19 Gemini 3.5: frontier intelligence with action](https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-3-5/)
...
* [2026/05/05 Accelerating Gemma 4: faster inference with multi-token prediction drafters](https://blog.google/innovation-and-ai/technology/developers-tools/multi-token-prediction-gemma-4/)
* [2026/04/26 NVIDIA 推出 Nemotron 3 Nano Omni 模型，整合視覺、音訊與語言，打造最高提升 9 倍效率的 AI 代理](https://blogs.nvidia.com.tw/blog/nemotron-3-nano-omni-multimodal-ai-agents/)
* [2026/04/24 DeepSeek V4 Preview Release](https://api-docs.deepseek.com/news/news260424)
* [2026/04/23 Introducing GPT-5.5](https://openai.com/zh-Hant/index/introducing-gpt-5-5/)
* [2026/04/22 Qwen3.6-35B-A3B-FP8](https://huggingface.co/Qwen/Qwen3.6-35B-A3B-FP8)
* [2026/04/16 Introducing GPT-Rosalind for life sciences research](https://openai.com/index/introducing-gpt-rosalind/)
* [2026/04/02 Gemma 4: Byte for byte, the most capable open models](https://blog.google/innovation-and-ai/technology/developers-tools/gemma-4/)
* [2026/03/16 V-JEPA 2.1: Unlocking Dense Features in Video Self-Supervised Learning](https://huggingface.co/papers/2603.14482)
* [2026/03/16 Nemotron-Cascade 2: Post-Training LLMs with Cascade RL and Multi-Domain On-Policy Distillation](https://research.nvidia.com/labs/nemotron/nemotron-cascade-2/)
* [2026/03/05 Introducing GPT-5.4](https://openai.com/index/introducing-gpt-5-4/)
* [2026/02/26 MediaTek Research Breeze 3：讓 AI 聽懂台語、說出台味、守護台灣](https://www.mediatek.com/zh-tw/tek-talk-blogs/mediatek-research-breeze-3)
* [2026/02/16 Qwen3.5：Towards Native Multimodal Agents](https://qwen.ai/blog?id=qwen3.5)
...
* [2026/01/28 RT-2: New model translates vision and language into action](https://deepmind.google/blog/rt-2-new-model-translates-vision-and-language-into-action/)
...
### 2025
* [2025/12/25 NVIDIA Nemotron 3 Family of Models](https://research.nvidia.com/labs/nemotron/Nemotron-3/)
...
* [2025/11/27 Z-Image: An Efficient Image Generation Foundation Model with Single-Stream Diffusion Transformer](https://arxiv.org/abs/2511.22699)
...
* [2024/09/19 Qwen2.5: 基础模型大派对！](https://qwenlm.github.io/zh/blog/qwen2.5/)
...
* [2024/05/08 Accurate structure prediction of biomolecular interactions with AlphaFold 3](https://www.nature.com/articles/s41586-024-07487-w)
...
* [2022/01/14 AI人工智慧取代大量人力，工業5.0時代它如何影響我們的生活？](https://www.bnext.com.tw/article/67299/ai-job-future)
...
![](https://github.com/rkuo2000/AI-course/blob/main/assets/images/Speed_of_AI_adoption_by_technology.png?raw=true)
![](https://github.com/rkuo2000/AI-course/blob/main/assets/images/Select_AI_Index_technical_performance_benchmarks_vs_human_performance.png?raw=true)

---
## AI的未來 

### [Sequoia AI Ascent 2026: The future of AI](https://www.theaiopportunities.com/p/sequoia-ai-ascent-2026-the-future)
![](https://github.com/rkuo2000/AI-course/blob/main/assets/images/AI-Acent-2026-Waves_of_Technology.webp?raw=true)
![](https://github.com/rkuo2000/AI-course/blob/main/assets/images/AI-Acent-2026-White_Space.png?raw=true)
![](https://github.com/rkuo2000/AI-course/blob/main/assets/images/AI-Acent-2026-Agentic-ness.jpg?raw=true)
<iframe width="1021" height="574" src="https://www.youtube.com/embed/LRo33rnv6rQ?list=PLOhHNjZItNnOkkZThzULo1Ygg7JR6T3MG" title="This is AGI: Sequoia AI Ascent 2026 Keynote" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

---
### NVIDIA GTC Taipei 2026 Keynote
<iframe width="1021" height="574" src="https://www.youtube.com/embed/wSp6AiNIrsY" title="NVIDIA GTC Taipei 2026 Keynote | Live" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
